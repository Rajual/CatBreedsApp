...
List<CatData> catDataFromMap(String str) =>
    List<CatData>.from(json.decode(str).map((x) => CatData.fromMap(x)));

String catDataToMap(List<CatData> data) =>
...
class CatData {
  ...
  factory CatData.fromMap(Map<String, dynamic> json) => CatData(
